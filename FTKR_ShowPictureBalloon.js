 ...
 *
 * @param フキダシアイコンサイズ
 * @desc フキダシアイコンのサイズを設定します。
 * @type struct<balloon>
 * @default {"width":"48","height":"48","speed":"8","waitTime":"12"}
 *
 * @help 
 *-----------------------------------------------------------------------------
 * 概要
 ...
 * 
 *    フキダシアイコンID
 *      ：表示させるフキダシアイコンを番号または文字で指定します。
 *      　\v[n]で変数を指定することも可能です。
 *      　番号とフキダシアイコンの関係は以下の通り。
 *      　　1  - びっくり
 *      　　2  - はてな
 *      　　3  - 音符
 *      　　4  - ハート
 ...
 *
 * @param speed
 * @desc フキダシアイコンの１コマの表示時間
 * @default 8
 * @type number
 *
 * @param waitTime
 * @desc フキダシアイコンの表示後のウェイト時間
 * @default 12
 * @type number
 *
*/
...
(function() {
    ...
    FTKR.SPB.balloon = paramParse(parameters['フキダシアイコンサイズ']);
