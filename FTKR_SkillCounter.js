...
/*:
 * @plugindesc v1.0.0 相手のスキルに対抗して効果を変えるプラグイン
 * @author フトコロ
 *
 * @help 
 *-----------------------------------------------------------------------------
 ...
 *    ください。
 * 
 * 2. FTKR_SkillExpansion.js と併用する場合は、本プラグインは
 *    FTKR_SkillExpansion.jsよりも下になるように配置してください。
 * 
 * 
 *-----------------------------------------------------------------------------
 * スキルの無効化
...
FTKR.SCT.Game_Action_executeSepDamage = Game_Action.prototype.executeSepDamage;
Game_Action.prototype.executeSepDamage = function(damage, target, value) {
    value = this.sctReversDamageType(target, value);
    FTKR.SCT.Game_Action_executeSepDamage.call(this, damage, target, value);
};
