...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver3.3.0](FTKR_CustomSimpleActorStatus.js) | 2018/09/15 | ステータスコードに、アイテム用のコードを追加<br>ステータスアイコン同士間の余白サイズを設定する機能を追加<br>ステータスアイコンを高さ幅が不足しても最低１つは表示させるように変更<br>プラグインパラメータ Enable Auto Scale を有効にした場合に、表示幅が小さい場合でもサイズ調整するように変更 |
