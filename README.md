...
| [FTKR_PopupSpriteMessage](FTKR_PopupSpriteMessage.js) | なし | [v1.2.1](https://raw.githubusercontent.com/futokoro/RPGMaker/master/FTKR_PopupSpriteMessage.js) | 2018/02/28 | 任意のメッセージを画面上にポップアップ表示する |
...
| [FTKR_AISkillEvaluate](FTKR_AISkillEvaluate.js) | なし | [v1.2.2](https://raw.githubusercontent.com/futokoro/RPGMaker/master/FTKR_AISkillEvaluate.js) | 2018/02/28 | 自動戦闘時に使用するスキルの評価値を個別に設定する |
...
* [FTKR_AISkillEvaluate](FTKR_AISkillEvaluate.js) v1.2.2
