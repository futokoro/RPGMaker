...
| [FTKR_ItemSubCommand](FTKR_ItemSubCommand.js) | [仮版](FTKR_ItemSubCommand.ja.md) | [v1.7.0](https://raw.githubusercontent.com/futokoro/RPGMaker/master/FTKR_ItemSubCommand.js) | 2012/12/22 | アイテムボックスにサブコマンドを追加し、アイテム画面でアイテムを捨てたり、装備変更ができるようになるプラグイン |
