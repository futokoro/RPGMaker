...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver1.3.1](FTKR_AlternatingTurnBattle.js)| 2018/07/27 | FTKR_FVActorAnimation.jsと組み合わせた時に、FTKR_FVActorAnimationのアクターエフェクト機能が正常に動作しない不具合を修正<br>FTKR_CustomSimpleActorStatus.jsで行動回数とアクションポイントを表示する機能を追加 |
