...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver2.0.1](FTKR_AlternatingTurnBattle.js) | 2018/12/02 | プラグインパラメータ Disable Change When Party Cannot Act を削除しパーティーが行動できなくなった時に、自動でパーティーコマンドに戻すように変更<br>パーティーが行動できなくなった時に、ターン終了コマンドに自動でカーソルを合わせる機能を追加 |
