...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver1.15.13](FTKR_SkillTreeSystem.js) | 2018/08/26 | FTKR_SkillExpansionと組み合わせている場合に、スキルツリー画面のスキル説明文が正しく表示できない不具合を修正<br>FTKR_SkillExpansionと組み合わせていても、スキルツリー側の説明文の設定を優先して表示する機能を追加 |
