...
| [FTKR_ExMessageWindow2](FTKR_ExMessageWindow2.js) | 作成中 | [v2.0.0](https://raw.githubusercontent.com/futokoro/RPGMaker/master/FTKR_ExMessageWindow2.js) | 2017/04/24 | メッセージの表示を拡張する(バージョン２) <br> FTKR_ExMessageWindowと組み合わせて使用できません |
...
| [FTKR_SkillCounter](FTKR_SkillCounter.js) | [あり](FTKR_SkillCounter.ja.md) | [v1.0.4](https://raw.githubusercontent.com/futokoro/RPGMaker/master/FTKR_SkillCounter.js) | 2017/04/23 | 相手のスキルに対抗して効果を変える |
