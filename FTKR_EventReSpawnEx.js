//=============================================================================
// EventReSpawn.jsで生成した一時イベントの座標とセルフスイッチを記録するプラグイン
...
//=============================================================================
/*:
 * @plugindesc v1.0.0 EventReSpawn.jsで生成した一時イベントの座標とセルフスイッチを記録する
 * @author フトコロ
 * 
 ...
 * 概要
 *-----------------------------------------------------------------------------
 * トリアコンタン氏製のイベント動的生成プラグインEventReSpawn.jsで
 * 生成した一時イベントの座標とセルフスイッチの状態を記録します。
 * 
 * 一度別の場所に移動した後に、再度同じマップに移動した場合に、
 * 記録した位置およびセルフスイッチの状態で一時イベントを生成します。
 * 
 * トリアコンタン氏製のテンプレートイベントプラグインTemplateEvent.jsと
 * 組み合わせて生成した一時イベントに対しても、使用することができます。
 * 
 * 
 * 以下のバージョンで動作確認済み。
 ...
 * this._eventId で、一時イベント自身のIDを指定できます。
 * 
 ...
 * 初期化します。
 * また、this._eventId で、一時イベント自身のIDを指定できます。
 * 
