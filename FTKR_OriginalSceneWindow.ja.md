...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver1.5.0](FTKR_OriginalSceneWindow.js) | 2018/02/14 | ゲーム内スイッチで、ウィンドウの表示のON/OFFを切り替える機能を追加s<br>プラグインパラメータで、ウィンドウの生成数を設定する機能を削除<br>バトルシーンでも、ウィンドウを作成するために生成コマンドの実行が必要なように変更 |
