...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver1.7.0](FTKR_ItemCompositionSystem.js) | 2018/10/14 | 合成に使用した素材を合成成功時でも復元する機能を追加<br>コマンドとタイトル文字列の表示位置を調整する機能を追加<br>合成時に複数のアイテムを入手できる詳細合成を追加<br>アイテム名とアイテム数の間に区切り文字を設定する機能を追加 |
