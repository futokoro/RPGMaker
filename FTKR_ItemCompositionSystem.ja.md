...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver1.5.0](FTKR_ItemCompositionSystem.js) | 2017/10/11 | 合成画面の表示内容を設定するプラグインパラメータの入力方式をリスト方式に変更<br>プラグインコマンドで合成画面を表示するときに、オプションでリスト番号を指定すると表示内容をリストの番号に合わせて変更する機能を追加<br>合成終了時に確認画面を表示する機能を追加 |
