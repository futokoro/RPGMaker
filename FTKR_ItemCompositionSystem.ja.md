...
| バージョン | 公開日 | 更新内容 |
| --- | --- | --- |
| [ver1.4.0](FTKR_ItemCompositionSystem.js) | 2017/10/07 | プラグインコマンドで背景画像を設定する機能を追加<br>特定のカテゴリーのアイテムだけ表示する合成コマンドを作成する機能を追加<br>合成コマンドの、素材選択時とレシピ選択時で変える機能を拡張し、素材選択時だけ、またはレシピ選択時だけ表示できる機能を追加 |
